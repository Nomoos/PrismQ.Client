...
class WorkerClient {
     ...
     */
    public function claimTask($typePattern = null) {
     ...
     * @throws Exception on API errors
     */
    public function failTask($taskId, $errorMessage, $result = null) {
        $data = [
            'worker_id' => $this->workerId,
            'success' => false,
            'error' => $errorMessage
     ...
     * @throws Exception on API errors
     */
    public function registerTaskType($name, $version, $paramSchema) {
        $data = [
            'name' => $name,
            'version' => $version,
